...
def update_project(
    ...
    for field in ("name", "vehicle_label", "ecu_label", "source_filename"):
        if field in data and data[field] is not None:
            setattr(row, field, data[field])
    if "requested_options" in data and data["requested_options"] is not None:
        row.requested_options = data["requested_options"]
